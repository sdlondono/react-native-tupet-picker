...
var CustomPicker = /** @class */ (function (_super) {
    ...
    CustomPicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, containerStyle = _a.containerStyle, modalAnimationType = _a.modalAnimationType, validate = _a.validate, fieldTemplate = _a.fieldTemplate, optionTemplate = _a.optionTemplate, placeholder = _a.placeholder, options = _a.options, headerTemplate = _a.headerTemplate, footerTemplate = _a.footerTemplate, style = _a.style, fieldTemplateProps = _a.fieldTemplateProps, optionTemplateProps = _a.optionTemplateProps, backdropStyle = _a.backdropStyle, modalStyle = _a.modalStyle, refreshControl = _a.refreshControl, scrollViewProps = _a.scrollViewProps;
        var actions = {
