...
var defaultFieldTemplate = function (_a) {
    ...
    return (React.createElement(react_native_1.View, {
        ...
        React.createElement(react_native_1.Text, { style: { textStyle, fontSize: (validate) ? 15 : 11, alignItems: 'center', color: '#999999', fontFamily: Constants.FONT_TEXT } }, (selectedItem && getLabel(selectedItem)) || defaultText),
