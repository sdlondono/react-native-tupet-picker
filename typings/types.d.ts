 ...
 */
export declare type FieldTemplateFunction<T = any> = (
  settings: FieldTemplateSettings<T>
) => JSX.Element
/**
 * A function to render option view.
 */
export declare type OptionTemplateFunction<T = any> = (
  settings: OptionTemplateSettings<T>
) => JSX.Element
/**
 * A function to render header.
 */
export declare type HeaderTemplateFunction<T = any> = (
  settings: CustomPickerActions<T>
) => JSX.Element
/**
 * A function to render footer.
 */
export declare type FooterTemplateFunction<T = any> = (
  settings: CustomPickerActions<T>
) => JSX.Element
/**
